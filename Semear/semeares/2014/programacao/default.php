...
<img alt="" src="../images/topo.png"/>
	...
	<div id="page_content">
		...
		<div id="column_l">
			...
			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 532pt" width="708">
				<colgroup>
					<col style="mso-width-source: userset; mso-width-alt: 8557; width: 176pt" width="234" />
				...
				<tr height="20">
					<td class="xl71" height="20" width="234">
					<span style="mso-bidi-font-family: Arial">13h00 - 
					Credenciamento<span style="mso-spacerun: yes">&nbsp;</span></span></td>
					<td class="xl78" width="208">&nbsp;</td>
					<td class="xl86" width="266">Secretaria do evento no hall<span style="mso-spacerun: yes">&nbsp;</span></td>
				</tr>
				<tr height="20">
					<td class="xl75" height="20">
					<span style="mso-bidi-font-family: Arial">&nbsp;</span></td>
					<td></td>
					<td class="xl87" width="266">&nbsp;</td>
				</tr>
				<tr height="20">
					<td class="xl76" height="20">
					<span style="mso-bidi-font-family: Arial">PALESTRAS - Teatro</span></td>
					<td></td>
					<td class="xl87" width="266">&nbsp;</td>
				</tr>
				<tr height="21">
				...
				<tr height="21">
					...
					<td class="xl84"><span style="mso-bidi-font-family: Arial">
					SemeAres</span></td>
					<td class="xl89" width="266">&nbsp;</td>
				</tr>
				<tr height="21">
					<td class="xl69" height="21">
					<span style="mso-bidi-font-family: Arial">&nbsp;</span></td>
					<td class="xl70">&nbsp;</td>
					<td class="xl87" width="266">&nbsp;</td>
				</tr>
				...
				<tr height="21">
					...
					Sebrae-Sãoo José dos Campos</span></td>
				...
				<tr height="20">
					...
					<td class="xl86" width="266">Fábrica dos-onhos: Visões do 
					futuro, agora!</td>
				</tr>
				<tr height="21">
					<td class="xl72" height="21">&nbsp;</td>
				...
				<tr height="30">
					<td class="xl71" height="30">
					<span style="mso-bidi-font-family: Arial">16h50 - 17h10</span></td>
 ...
 collapse;width:532pt" width="708">
				<colgroup>
					<col width="234" /><col width="208" /><col width="266" />
				</colgroup>
				<tr height="20">
  ...
  Symbol">·<font class="font6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font><font class="font5">Mediadora: 
					Andrea Kirst<span style="mso-spacerun:yes">&nbsp;</span></font></span></td>
					<td class="xl68" width="266"></td>
				</tr>
				<tr height="20">
					<td height="20"></td>
					<td class="xl67">
					<span style="mso-bidi-font-family:Symbol;mso-fareast-font-family:
  Symbol">·<font class="font6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font><font class="font5">Alexandre 
					Robazza<span style="mso-spacerun:yes">&nbsp; </span>- Sebrae</font></span></td>
					<td class="xl68" width="266"></td>
				</tr>
				<tr height="20">
					<td height="20"></td>
					<td class="xl67">
					<span style="mso-bidi-font-family:Symbol;mso-fareast-font-family:
  Symbol">·<font class="font6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pedro Kayatt</font><font class="font5"><span style="mso-spacerun:yes">&nbsp;
					</span>- Naked Monkey Games</font></span></td>
					<td class="xl68" width="266"></td>
				</tr>
				<tr height="20">
  ...
  Arial">16h30 às 17h00</span></td>
				...
				<tr height="20">
					...
					<td class="xl67">
					<span style="mso-bidi-font-family:Symbol;mso-fareast-font-family:
  Symbol">·<font class="font6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font><font class="font5">Mediador: 
					Rodrigo Junqueira</font></span></td>
					<td class="xl68" width="266"></td>
				</tr>
				<tr height="20">
					<td height="20"></td>
					<td class="xl67">
					<span style="mso-bidi-font-family:Symbol;mso-fareast-font-family:
  Symbol">·<font class="font6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font><font class="font5">Gustavo 
					Cunha - CASD Vestibulares</font></span></td>
					<td class="xl68" width="266"></td>
				</tr>
				<tr height="20">
					<td height="20"></td>
