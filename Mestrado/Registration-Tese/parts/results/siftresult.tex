...
%SIFT-1,SIFT-50,SIFT-100,SIFT-1000
\begin{figure}[H]
\centering
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SIFT-10, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	 \addplot table [x=Argument, y=SIFT-20, col sep=comma] {graphs/scale-all-\gtype.csv};
	 \addplot table [x=Argument, y=SIFT-30, col sep=comma] {graphs/scale-all-\gtype.csv};
 	 \addplot table [x=Argument, y=SIFT-40, col sep=comma] {graphs/scale-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SIFT-10, col sep=comma]	{graphs/rot-all-\gtype.csv}; 
	 \addplot table [x=Argument,	y=SIFT-20, col	sep=comma] {graphs/rot-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=SIFT-30, col sep=comma] {graphs/rot-all-\gtype.csv};		
 	 \addplot table [x=Argument, y=SIFT-40, col sep=comma] {graphs/rot-all-\gtype.csv};
		 %eixo horizontal
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SIFT-10, col sep=comma]	{graphs/blur-all-\gtype.csv}; 
	\addplot table [x=Argument, y=SIFT-20, col sep=comma] {graphs/blur-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=SIFT-30, col sep=comma] {graphs/blur-all-\gtype.csv};
 	 \addplot table [x=Argument, y=SIFT-40, col sep=comma] {graphs/blur-all-\gtype.csv};	
	%eixo horizontal
	\addplot[red,sharp plot,update limits=false] coordinates{(\minx,\ylimit)(\maxx,\ylimit)};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SIFT-10, col sep=comma]	{graphs/bright-all-\gtype.csv};
	\addplot table [x=Argument,	y=SIFT-20, col	sep=comma] {graphs/bright-all-\gtype.csv}; 
	 	 \addplot table [x=Argument, y=SIFT-30, col sep=comma] {graphs/bright-all-\gtype.csv};
 	 \addplot table [x=Argument, y=SIFT-40, col sep=comma] {graphs/bright-all-\gtype.csv};	
	%eixo horizontal
	\addplot[red,sharp plot,update limits=false] coordinates	{(\minx,\ylimit)(\maxx,\ylimit)};
...
\end{tikzpicture}
\label{graph:siftresultpres}
\caption{Resultado de testes individuais de preformance com SIFT}
\end{figure}
...
\end{tikzpicture}
\label{graph:siftresulttime}
\caption{Resultado de testes individuais de tempo com SIFT}
\end{figure}
