...
%Argument,ORB-15,ORB-100,ORB-500,ORB-1000
\begin{figure}[H]
\centering
...
\begin{axis}
    ...
    xlabel=$Scale Factor$,
	legend entries={$d=10$,$d=12$,$d=14$,$d=16$},
	title= Robustness to scaling
    ]
	\addplot table [x=Argument, y=ORB-10, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	 \addplot table [x=Argument, y=ORB-12, col sep=comma] {graphs/scale-all-\gtype.csv};
	 \addplot table [x=Argument, y=ORB-14, col sep=comma] {graphs/scale-all-\gtype.csv};
 	 \addplot table [x=Argument, y=ORB-16, col sep=comma] {graphs/scale-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=ORB-10, col sep=comma]	{graphs/rot-all-\gtype.csv}; 
	 \addplot table [x=Argument,	y=ORB-12, col	sep=comma] {graphs/rot-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=ORB-14, col sep=comma] {graphs/rot-all-\gtype.csv};		
 	 \addplot table [x=Argument, y=ORB-16, col sep=comma] {graphs/rot-all-\gtype.csv};
		 %eixo horizontal
...
\begin{axis}
	...
	\addplot table [x=Argument, y=ORB-10, col sep=comma]	{graphs/blur-all-\gtype.csv}; 
	\addplot table [x=Argument, y=ORB-12, col sep=comma] {graphs/blur-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=ORB-14, col sep=comma] {graphs/blur-all-\gtype.csv};
 	 \addplot table [x=Argument, y=ORB-16, col sep=comma] {graphs/blur-all-\gtype.csv};	
	%eixo horizontal
	\addplot[red,sharp plot,update limits=false] coordinates{(\minx,\ylimit)(\maxx,\ylimit)};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=ORB-10, col sep=comma]	{graphs/bright-all-\gtype.csv};
	\addplot table [x=Argument,	y=ORB-12, col	sep=comma] {graphs/bright-all-\gtype.csv}; 
	 	 \addplot table [x=Argument, y=ORB-14, col sep=comma] {graphs/bright-all-\gtype.csv};
 	 \addplot table [x=Argument, y=ORB-16, col sep=comma] {graphs/bright-all-\gtype.csv};	
	%eixo horizontal
	\addplot[red,sharp plot,update limits=false] coordinates	{(\minx,\ylimit)(\maxx,\ylimit)};
...
\end{tikzpicture}
\label{graph:orbresultpres}
\caption{Resultado de testes individuais de preformance com ORB}
\end{figure}
...
\end{tikzpicture}
\label{graph:orbresulttime}
\caption{Resultado de testes individuais de tempo com ORB}
\end{figure}
