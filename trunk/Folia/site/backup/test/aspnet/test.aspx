...
<script runat="server">
    ...
    readonly string[] tab_legends = new string[] { "Test MySQL Connection", "Test MSSQL Connection", "Test MS Access Connection", "Test mail sending", "Environment" };
    readonly string[] tab_descriptions = new string[] {@"
        This page allows to check connectivity between the SQL client on your
        host and one of remote database servers. You should have working accounts on the
        database servers you want to test. Here you can test the ability to connect to the MySQL server.",@"
        Here you can test the ability to connect to the Microsoft SQL server.",@"
        Here you can test the ability to connect to the Microsoft Access server.",@"
        This page allows you to test mail sending through the local Plesk Control Panel's SMTP mail server. You need to supply the sender's e-mail address or name, message subject and message body.",@" 
        This page allows you to check if the extension environment settings can be retrieved." };
    ...
    void DBTestTest_Click(object sender, EventArgs e)
    {
        ...
        //mes += " Trying to connect.";
        try
        {
            con.Open();
            mes += " Connection established.";
            con.Close();
            mes += " Disconnecting from the server.";
            mes += " The test completed sucessfully.";
    ...
    {
        string mes = string.Empty;
        string sTo = "beto@aspsolutions.com.br";
    ...
    void MakeMessage(bool success, string message)
    {
        ...
        lb.Text = success ? "Success:" : "Failure:";
        L.Text = message ;
        pn.Controls.Add(lb);
        pn.Controls.Add(L);
