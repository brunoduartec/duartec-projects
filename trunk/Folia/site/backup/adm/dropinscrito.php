    ...
    <?php
		...
		while($row = mysql_fetch_array($result))
		{
            ...
            <tr>
                ...
                <td width="20%"><form method="post" action="./dropconfir.php"><input type="hidden" value="<?php echo $row['codigo']; ?>" name="codigo">
                <input type="submit" value="Deletar" name="visu"></form></td>
            </tr>
            <?php
			$i=$i+1;
			}
