...
\begin{axis}
	...
	\addplot table [x=Argument, y=FREAK-2300, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	\addplot table [x=Argument, y=FREAK-2600, col	sep=comma] {graphs/scale-all-\gtype.csv}; 
	\addplot table [x=Argument,	y=FREAK-2900, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	\addplot table	[x=Argument, y=FREAK-3200, col	sep=comma]	 {graphs/scale-all-\gtype.csv};
