...
%STAR-1,STAR-50,STAR-100,STAR-1000
\begin{figure}[H]
\centering
...
\begin{axis}
	...
	\addplot table [x=Argument, y=STAR-10, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	 \addplot table [x=Argument, y=STAR-20, col sep=comma] {graphs/scale-all-\gtype.csv};
	 \addplot table [x=Argument, y=STAR-30, col sep=comma] {graphs/scale-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=STAR-40, col sep=comma]	 {graphs/scale-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=STAR-10, col sep=comma]	{graphs/rot-all-\gtype.csv}; 
	 \addplot table [x=Argument,	y=STAR-20, col	sep=comma] {graphs/rot-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=STAR-30, col sep=comma] {graphs/rot-all-\gtype.csv};		
	 	 	 	 \addplot table [x=Argument, y=STAR-40, col sep=comma]
...
\begin{axis}
	...
	\addplot table [x=Argument, y=STAR-10, col sep=comma]	{graphs/blur-all-\gtype.csv}; 
	\addplot table [x=Argument, y=STAR-20, col sep=comma] {graphs/blur-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=STAR-30, col sep=comma] {graphs/blur-all-\gtype.csv};
	 	 	 	 \addplot table [x=Argument, y=STAR-40, col sep=comma]
	 	 {graphs/blur-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=STAR-10, col sep=comma]	{graphs/bright-all-\gtype.csv};
	\addplot table [x=Argument,	y=STAR-20, col	sep=comma] {graphs/bright-all-\gtype.csv}; 
	 	 \addplot table [x=Argument, y=STAR-30, col sep=comma] {graphs/bright-all-\gtype.csv};
	 	 	 	 \addplot table [x=Argument, y=STAR-40, col sep=comma]
...
\end{tikzpicture}
\label{graph:starresultpres}
\caption{Resultado de testes individuais de preformance com STAR}
\end{figure}
...
\label{graph:starresulttime}
\caption{Resultado de testes individuais de tempo com STAR}
\end{figure}
