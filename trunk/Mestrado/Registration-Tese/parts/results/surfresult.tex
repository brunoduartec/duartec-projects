...
\begin{center}
SURFDetector(int _maxSize=45, int _responseThreshold=30,
...
\begin{axis}
    ...
    xlabel=$Scale Factor$,
	legend entries={$d=200$,$d=400$,$d=600$,$d=800$},
	title= Robustness to scaling
    ]
	\addplot table [x=Argument, y=SURF-200, col sep=comma]	{graphs/scale-all-\gtype.csv}; 
	 \addplot table [x=Argument, y=SURF-400, col sep=comma] {graphs/scale-all-\gtype.csv};
	 	\addplot table [x=Argument, y=SURF-600, col sep=comma]	 	{graphs/scale-all-\gtype.csv};
	 	 \addplot table [x=Argument, y=SURF-800, col	 	sep=comma] {graphs/scale-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SURF-200, col sep=comma]	{graphs/rot-all-\gtype.csv}; 
	 \addplot table [x=Argument,	y=SURF-400, col	sep=comma] {graphs/rot-all-\gtype.csv};
	 	\addplot table [x=Argument, y=SURF-600, col sep=comma]	 	{graphs/rot-all-\gtype.csv}; 
	 	\addplot table [x=Argument,	y=SURF-800, col	 	sep=comma] {graphs/rot-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SURF-200, col sep=comma]	{graphs/blur-all-\gtype.csv}; 
	\addplot table [x=Argument, y=SURF-400, col sep=comma] {graphs/blur-all-\gtype.csv};
		\addplot table [x=Argument, y=SURF-600, col sep=comma]		{graphs/blur-all-\gtype.csv};
		 \addplot table [x=Argument, y=SURF-800, col		sep=comma] {graphs/blur-all-\gtype.csv};
...
\begin{axis}
	...
	\addplot table [x=Argument, y=SURF-200, col sep=comma]	{graphs/bright-all-\gtype.csv};
	\addplot table [x=Argument,	y=SURF-400, col	sep=comma] {graphs/bright-all-\gtype.csv}; 
		\addplot table [x=Argument, y=SURF-600, col sep=comma]		{graphs/bright-all-\gtype.csv}; 
		\addplot table [x=Argument,	y=SURF-800, col		sep=comma] {graphs/bright-all-\gtype.csv};
...
\end{tikzpicture}
\label{graph:surfresultpres}
\caption{Resultado de testes individuais de preformance com SURF}
\end{figure}
...
\label{graph:surfresulttime}
\caption{Resultado de testes individuais de tempo com SURF}
\end{figure}
