...
localizadas e o número de características na Figura inicial. Idealmente, o valor
...
Inicialmente, foram considerados os resultados que se demonstraram dentro de
 ...
 Como mostrado na Figura \ref{graph:scaleresultpres}, para os testes de Escala
...
\end{figure}
 ...
 estão dentro da janela as técnicas BRISK,
 FAST, FREAK, GFTT, MSER, ORB, STAR, SURF, SIFT
...
\renewcommand{\ylabel}{Time(Ms)}
 ...
 Como mostrado na Figura~\ref{graph:scaleresulttime}, para os testes de
