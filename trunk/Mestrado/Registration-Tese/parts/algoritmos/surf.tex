...
SIFT que aproxima Laplacianas de Gaussianas(LoG) por Diferenças de
Gaussianas(DoG), aproximando LoG por \emph{Box-type Filter}, como mostrado na Figura~\ref{fig:surf01}, não sendo
utilizado nenhum tipo de suavização entre escalas , o que garante mais agilidade nos resultados
 porque as convoluções com \emph{box filters} são muito mais rápidas com o uso
...
A janela é então dividida em $ 4 \times 4$ sub regiões regulares. Cada
sub-região é dividida em $5 \times 5$ pontos amostrais distribuidos uniformemente.
