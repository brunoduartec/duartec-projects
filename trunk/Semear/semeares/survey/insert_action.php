...
if (getenv("REQUEST_METHOD") == "POST") {
   ...
   // "normais" do PHP (Requer apenas nas versões do PHP acima da 4.1)
	...
	$palestra1 = $_POST['palestrante1'];
	$palestra2 = $_POST['palestrante2'];
	$gosto = $_POST['gosto'];
    ...
    mysql_select_db("abraaoba_isemear",$conexao);
		...
		$query = "INSERT INTO pes_encontro(penc_nome,penc_email,penc_palestra01,penc_palestra02,penc_gosto,penc_nao_gosto,penc_sugiro,penc_proximo,penc_duracao,penc_organizacao,penc_participacao,penc_iniciativa) values('$nome','$email','$palestra1','$palestra2','$gosto','$nao_gosto','$sugiro','$proximo','$duracao','$organizacao','$participacao','$iniciativa')";
		mysql_query($query,$conexao);
    
		$err = "Muito obrigado por responder à nossa pesquisa<br> Equipe de organização do SemeAres";	
